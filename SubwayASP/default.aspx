            ...
            <div class="topArea">
                <table border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                        <td>
                            起始站：
                            <asp:DropDownList ID="ddlBegin" runat="server" Width="133px">
                            </asp:DropDownList>

                            终点站：
                            <asp:DropDownList ID="ddlEnd" runat="server" Width="133px">
                            </asp:DropDownList>
                            选项：
                            <asp:DropDownList ID="ddlOptions" runat="server" Width="133px">
